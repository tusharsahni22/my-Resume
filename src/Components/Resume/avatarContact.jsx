...
export default function AvatarContact() {
  ...
  return (
    <div>
      <PhotoContainer>
        <ProfilePicture src="/images/Tushar.jpg" alt="profile" />
      </PhotoContainer>
      <ContactSection>
        ...
        <FlexRow>
          <PhoneAndroidIcon />
          <Typography className={classes.f12}>+91-8744826626</Typography>
        </FlexRow>
        ...
        <FlexRow className={classes.gitButton}>
          <Button type="button" className={`${classes.f12} ${classes.button}`}>
            ...
            <Typography style={{ marginLeft: "10px" }} className={classes.f12}>
              <AnchorLinks
                href="https://github.com/tusharsahni22"
                target="_blank"
              >
                Github
              </AnchorLinks>
        ...
        <FlexRow>
          ...
          <Typography style={{ marginLeft: "10px" }} className={classes.f12}>
            <AnchorLinks
              href="https://linkedin.com/in/tusharsahni22"
              target="_blank"
            >
              LinkedIn
            </AnchorLinks>
